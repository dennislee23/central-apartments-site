<?php
// Reverse proxy for the "Apartments" page (rendered by the worker from D1).
...
$WORKER = 'https://roland-bot.hello-071.workers.dev/apartments';
$body = false; $code = 0;
...
echo $body !== false ? $body : 'Apartments page temporarily unavailable.';
